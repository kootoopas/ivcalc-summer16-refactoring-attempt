...
selectors.APP_CONTAINER_ID = 'calculator';
...
selectors.$c = function (className, node) { //Get elements by class
  var a;
  var re;
  var els;

  node = node || document.getElementById(selectors.APP_CONTAINER_ID);
